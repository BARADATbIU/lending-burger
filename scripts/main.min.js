...
(function () {
  ...
  function accordionTeam() {
    ...
    teamAccord.addEventListener('click', function (e) {
      e.preventDefault();
      workTeam(e);
    });
  ...
  function accordionMenu() {
    ...
    menuAccord.addEventListener('click', function (e) {
      e.preventDefault();
      workMenu(e);
    });
      ...
      function moveMenu() {
        ...
        if (!item.classList.contains('is-active')) {
          ...
          for (var _i = 0; _i < menuItems.length; _i++) {
            if (menuItems[_i] == item) {
              num = menuItems.length - 1 - _i;
            }
          }
  ...
  function showIngred() {
    ...
    try {
      for (var _iterator5 = ingredClose[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        _i2.addEventListener('touchstart', addHidden);
      }
    } catch (err) {
    ...
    function addHidden() {
      ...
      try {
        for (var _iterator6 = burgerDrop[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          ...
          _i3.classList.add('visually-hidden');
        }
      } catch (err) {
    ...
    function remHidden() {
      ...
      try {
        for (var _iterator7 = burgerDrop[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var _i4 = _step7.value;

          _i4.classList.remove('visually-hidden');
        }
      } catch (err) {
