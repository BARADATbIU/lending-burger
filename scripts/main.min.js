...
(function () {
  ...
  function popupReview() {
    ...
    reviews.addEventListener('click', function (e) {
      if (e.target.classList.contains('btn--review')) {
        var head = e.target.parentNode.firstElementChild.textContent;
        var text = e.target.previousElementSibling.firstElementChild.textContent;
  ...
  function orderForm() {
    ...
    function getResponse(e) {
      ...
      fetch(url, { method: type, body: formData, headers: myHeaders }).then(checkStatus).then(function (response) {
